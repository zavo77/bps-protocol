...
> sign requests). P0.2B FINAL BLOCKERS deployed at 7c30dc39744b (fail-closed validity refresh with DB-capped staleAfter; never-promote conflict handling; 499 tests + browser proof 1-tx/0-sign; indexer parity healthy). P0.2A at 0f60395265f3 (fail-closed prepare 503, stable review identity via stored-manifest reuse, in-lock all-field re-check, safe conflict adoption; 489 tests + browser proof 1-tx/0-sign). P0.2 base at 15a9e9351c96: immutable
