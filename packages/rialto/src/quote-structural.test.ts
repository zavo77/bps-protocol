...
function makeQuote(over: Partial<RialtoQuoteResult> = {}): RialtoQuoteResult {
  ...
  return {
    ...
    meta: {
      ...
      buyToken: NVDA,
      requestedSellAmountDecimal: "1",
      returnedSellAmountRaw: AMOUNT.toString(),
      buyAmountRaw: null,
      minBuyAmountRaw: "1",
      ...
      issues: { balance: "none", simulationIncomplete: false, allowanceSpender: null },
      routeLegs: null,
      txTarget: ROUTER,
      selector: "0xaabbccdd",
      callDataBytes: 0,
