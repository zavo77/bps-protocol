...
const label = a.meta.executable === true ? "EXECUTION-ENABLED canary — signing only via per-tx Rabby approval (this task performed no signing/broadcast)" : (a.meta.mode === "live" ? "LIVE packet — preparation only" : "historical fixture — non-live, non-executable");
