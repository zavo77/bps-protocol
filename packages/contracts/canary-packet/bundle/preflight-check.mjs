...
// ---- authorization flags must still be false ----
const f = a.safetyFlags;
gate("8. all four authorization flags still false", f.broadcastReady === false && f.liveWritesApproved === false && f.executionAuthorized === false && f.fundingAuthorized === false);
